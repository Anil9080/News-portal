  <div class="col-md-4">
          ...
          <!-- Search Widget -->
          <div class="card mb-4">
            <h5 style="background-color: rgb(9 53 101 / 25%);" class="card-header" >Search</h5>
            <div class="card-body">
        ...
        <input type="text" name="searchtitle" class="form-control" placeholder="Search for..." required>
          ...
          <!-- Categories Widget -->
          <div class="card my-4">
            <h5 style="background-color: rgb(9 53 101 / 25%);" class="card-header">Categories</h5>
            <div class="card-body">
              <div class="row">
                <div class="col-lg-6">
...
<?php } ?>
          ...
          <!-- Side Widget -->
          <div class="card my-4">
            <h5 style="background-color: rgb(9 53 101 / 25%);"class="card-header">Recent News</h5>
            <div class="card-body">
                      <ul class="mb-0">
