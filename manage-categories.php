...
<html lang="en">
    <head>
        ...
        <title> TATHYADARPAN| Manage Categories</title>
    ...
    <body class="fixed-left" style="background-color: black;">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title"><a style="color: white;">Manage Categories</a></h4>
...
<div class="m-b-30">
 ...
 <h4><i class="fa fa-trash-o" ></i><a style="color: white;"> Deleted Categories</a></h4>
